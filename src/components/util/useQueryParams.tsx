...
const pairs = (arr:[]) => arr.reduce((acc:any, x, i) => {
    if (i % 2 === 0) {
        return [...acc, [x]];
    } else {
...
const fold = (arr:any) => pairs(arr).reduce((acc:any, pair:any) => {
    return {
        ...acc,
        [pair[0]]: pair[1],
    }
...
export const useQueryParams = () => {
    ...
    const currentParamsObj : URLSearchParams = new URLSearchParams(location.search);
